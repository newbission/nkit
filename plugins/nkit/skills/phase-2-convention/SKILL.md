...
```
No: Organizing env vars just before deployment
   -> Missing variables, naming inconsistency, deployment delays

Yes: Establish convention at design stage
...
No: Developing without architecture
   -> Spaghetti code, multiple file changes for each modification

Yes: Define layers at design stage
...
```typescript
// Bad: Handles only specific case
...
// Good: Generalized with interface
